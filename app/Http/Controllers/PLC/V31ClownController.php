...
class V31ClownController extends Controller
{
    //取值韋峯部分
    // 洗分控制
    ...
    //退幣ON
    CONST REFUND_ON = '01 05 08 AC FF 00 4E 7B';
    //退幣OFF
    CONST REFUND_OFF = '01 05 08 AC 00 00 0F 8B';
    // 投幣ＯＮ
    ...
    public function washPointControl($ip, $port)
    {
        ...
        while(!$result && $count < 5) {
            ...
            logger('v31_clown_wash_point_control');
            logger('ip:'.$ip);
            logger('port:'.$port);
    ...
    public function openPointControl($ip, $port)
    {
        ...
        while (!$result && $count < 5) {
            ...
            logger('v31_clown_open_point_control');
            logger('ip:'.$ip);
            logger('port:'.$port);
    ...
    public function openPointStatus($ip, $port)
    {
        ...
        while(!$result && $count < 5) {
            ...
            logger('v31_clown_open_point_status');
            logger('ip:'.$ip);
            logger('port:'.$port);
    ...
    public function openPointZero($ip, $port)
    {
        ...
        while (!$result && $count < 5){
            ...
            logger('v31_clown_open_point_zero');
            logger('ip:'.$ip);
            logger('port:'.$port);
    ...
    public function scoreAndRewardStatusZero($ip, $port)
    {
        ...
        while(!$result && $count < 5) {
            ...
            logger('v31_clown_score_reward_status_zero');
            logger('ip:'.$ip);
            logger('port:'.$port);
    ...
    public function grandRewardZero($ip, $port)
    {
        ...
        while(!$result && $count < 5) {
            ...
            logger('v31_clown_big_reward_status_zero');
            logger('ip:'.$ip);
            logger('port:'.$port);
    ...
    public function smallRewardZero($ip, $port)
    {
        ...
        while(!$result && $count < 5 ) {
            ...
            logger('v31_clown_small_reward_status_zero');
            logger('ip:'.$ip);
            logger('port:'.$port);
    ...
    public function sevenDisplay($ip, $port)
    {
        ...
        while(!$result && $count < 5) {
            ...
            logger('v31_clown_seven_display');
            logger('ip:'.$ip);
            logger('port:'.$port);
    ...
    public function bigRewardStatus($ip, $port)
    {
        ...
        while(!$result && $count < 5) {
            ...
            logger('v31_clown_big_reward_status');
            logger('ip:'.$ip);
            logger('port:'.$port);
    ...
    public function smallRewardStatus($ip, $port)
    {
        ...
        while(!$result && $count < 5) {
            ...
            logger('v31_clown_samll_reward_status');
            logger('ip:'.$ip);
            logger('port:'.$port);
    ...
    public function joystickShort($ip, $port)
    {
        ...
        while(!$result && $count < 5) {
            ...
            logger('v31_clown_joystick_short');
            logger('ip:'.$ip);
            logger('port:'.$port);
    ...
    public function joystickLong($ip, $port)
    {
        ...
        while(!$result_on && $count_on < 5) {
            ...
            logger('v31_clown_joystick_long');
            logger('ip:'.$ip);
            logger('port:'.$port);
        ...
        while(!$result_off && $count_off < 5) {
            ...
            logger('v31_clown_joystick_long_stop');
            logger('ip:'.$ip);
            logger('port:'.$port);
