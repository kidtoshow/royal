...
class V3ClownController extends Controller
{
    //取值韋峯部分
    // 洗分控制
    ...
    public function washPointControl($ip, $port)
    {
        ...
        while(!$result && $count < 5) {
            ...
            logger('v3_clown_wash_point_control');
            logger('ip:'.$ip);
            logger('port:'.$port);
    ...
    public function openPointControl($ip, $port)
    {
        ...
        while (!$result && $count < 5) {
            ...
            logger('v3_clown_open_point_control');
            logger('ip:'.$ip);
            logger('port:'.$port);
    ...
    public function openPointStatus($ip, $port)
    {
        ...
        while(!$result && $count < 5) {
            ...
            logger('v3_clown_open_point_status');
            logger('ip:'.$ip);
            logger('port:'.$port);
    ...
    public function openPointZero($ip, $port)
    {
        ...
        while (!$result && $count < 5){
            ...
            logger('v3_clown_open_point_zero');
            logger('ip:'.$ip);
            logger('port:'.$port);
    ...
    public function scoreAndRewardStatusZero($ip, $port)
    {
        ...
        while(!$result && $count < 5) {
            ...
            logger('v3_clown_score_reward_status_zero');
            logger('ip:'.$ip);
            logger('port:'.$port);
    ...
    public function grandRewardZero($ip, $port)
    {
        ...
        while(!$result && $count < 5) {
            ...
            logger('v3_clown_big_reward_status_zero');
            logger('ip:'.$ip);
            logger('port:'.$port);
    ...
    public function smallRewardZero($ip, $port)
    {
        ...
        while(!$result && $count < 5 ) {
            ...
            logger('v3_clown_small_reward_status_zero');
            logger('ip:'.$ip);
            logger('port:'.$port);
    ...
    public function bigRewardStatus($ip, $port)
    {
        ...
        while(!$result && $count < 5) {
            ...
            logger('v3_clown_big_reward_status');
            logger('ip:'.$ip);
            logger('port:'.$port);
    ...
    public function smallRewardStatus($ip, $port)
    {
        ...
        while(!$result && $count < 5) {
            ...
            logger('v3_clown_samll_reward_status');
            logger('ip:'.$ip);
            logger('port:'.$port);
    ...
    public function joystickShort($ip, $port)
    {
        ...
        while(!$result && $count < 5) {
            ...
            logger('v3_clown_joystick_short');
            logger('ip:'.$ip);
            logger('port:'.$port);
    ...
    public function joystickLong($ip, $port)
    {
        ...
        while(!$result_off && $count_off < 5) {
            ...
            logger('v3_clown_joystick_long_stop');
            logger('ip:'.$ip);
            logger('port:'.$port);
